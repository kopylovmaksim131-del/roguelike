...
namespace ArkanoidGame
{
	void GameStateMainMenuData::Init()
	{
		...
		bool isInfiniteApples = Application::Instance().GetGame().IsEnableOptions(GameOptions::InfiniteApples);
		...
		optionsInfiniteApplesItem.onPressCallback = [](MenuItem& item) {
			...
			bool isInfiniteApples = game.IsEnableOptions(GameOptions::InfiniteApples);
			item.text.setString("Infinite Apples: " + std::string(isInfiniteApples ? "On" : "Off"));
			};

		bool isWithAcceleration = Application::Instance().GetGame().IsEnableOptions(GameOptions::WithAcceleration);
		...
		optionsWithAccelerationItem.onPressCallback = [](MenuItem& item) {
			...
			bool isWithAcceleration = game.IsEnableOptions(GameOptions::WithAcceleration);
